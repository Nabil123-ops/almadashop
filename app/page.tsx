...
import Head from "next/head" // <-- IMPORTED Head FOR META TAGS
...
export default async function HomePage() {
  ...
  return (
    <>
      {/* -------------------
         HEAD META TAGS FOR OG / WHATSAPP
      ------------------- */}
      <Head>
        <title>Almada Shop - Quality Products Delivered</title>
        <meta name="description" content="Shop electronics, fashion, kids, and more with Cash on Delivery!" />

        {/* Open Graph / WhatsApp */}
        <meta property="og:title" content="Almada Shop - Quality Products Delivered" />
        <meta property="og:description" content="Shop electronics, fashion, kids, and more with Cash on Delivery!" />
        <meta property="og:image" content="https://image2url.com/r2/default/images/1770886922576-cf83b565-3df0-4e97-bd6e-de3c911e1812.jpeg" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:url" content="https://almadashop.vercel.app" />
        <meta property="og:type" content="website" />

        {/* Twitter cards (optional) */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Almada Shop - Quality Products Delivered" />
        <meta name="twitter:description" content="Shop electronics, fashion, kids, and more with Cash on Delivery!" />
        <meta name="twitter:image" content="https://image2url.com/r2/default/images/1770886922576-cf83b565-3df0-4e97-bd6e-de3c911e1812.jpeg" />
      </Head>
